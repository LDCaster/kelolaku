             ...
             <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                 ...
                 <li class="menu nav-item">
                     <button type="button" class="nav-link group"
                         :class="{ 'active': activeDropdown === 'blox-fruit' }"
                         @click="activeDropdown === 'blox-fruit' ? activeDropdown = null : activeDropdown = 'blox-fruit'">
                         <div class="flex items-center">
                             <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                 viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'blox-fruit' }">
                     ...
                     <ul x-cloak="" x-show="activeDropdown === 'blox-fruit'" x-collapse=""
                         class="sub-menu text-gray-500">
                         <li>
                             <a href="apps-invoice-list.html">Daftar Paket</a>
                         </li>
                         <li>
                             <a href="apps-invoice-preview.html">Stock</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li class="menu nav-item">
                     <button type="button" class="nav-link group"
                         :class="{ 'active': activeDropdown === 'grow-a-garden' }"
                         @click="activeDropdown === 'grow-a-garden' ? activeDropdown = null : activeDropdown = 'grow-a-garden'">
                         <div class="flex items-center">
                             <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                 viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                         ...
                         <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'grow-a-garden' }">
                             <svg width="16" height="16" viewbox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                     stroke-linecap="round" stroke-linejoin="round"></path>
                     ...
                     <ul x-cloak="" x-show="activeDropdown === 'grow-a-garden'" x-collapse=""
                         class="sub-menu text-gray-500">
                         <li>
                             <a href="apps-invoice-list.html">Daftar Paket</a>
                         </li>
